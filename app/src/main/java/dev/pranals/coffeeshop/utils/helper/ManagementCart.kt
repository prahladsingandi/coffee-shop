...
import dev.pranals.coffeeshop.utils.helper.ChangeNumberItemsListener
import dev.pranals.coffeeshop.utils.helper.TempDB
import dev.pranals.coffeeshop.utils.helper.TinyDB


class ManagementCart(val context: Context) {

    private val tinyDB = TempDB(context.applicationContext)
    ...
    fun removeItem(listItems: ArrayList<ItemModel>, position: Int, listener: ChangeNumberItemsListener) {
